...
var result1 = add(5, "hello", true); // here i am writing <number,string> but i i dont write then also it is fine
var result2 = add("world", true, false); // here i don't write then also it is fine due to infere in TS
